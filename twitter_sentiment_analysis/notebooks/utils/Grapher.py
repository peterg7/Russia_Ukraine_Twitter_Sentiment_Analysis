...
class Grapher:
    ...
    graphWordDist = lambda word_vecs: Grapher.graphDistribution(word_vecs, 'sentiment', 'Sentiment Distribution of Words')
    graphTweetDist = lambda tweet_df: Grapher.graphDistribution(tweet_df, 'sentiment', 'Sentiment Distribution of Tweets')

    graphUsernames = lambda tweets_df: Grapher.graphCounts(tweets_df, 'username', 'sentiment', 'Top 10 Highest Tweeting usernames', tweets_df['username'].value_counts().iloc[:10].index)
    graphHashtags = lambda tweets_df: Grapher.graphCounts(tweets_df, 'hashtags', 'sentiment', 'Top 10 Hashtags', tweets_df['hashtags'].value_counts().iloc[1:10].index, (15,10))
